...
selectable-set-headofsecurity-modsuit-desc = A modsuit with expensive plastitanium armour for the head of security's use.
selectable-set-engineering-voidsuit-name = Engineering Hardsuit
selectable-set-engineering-voidsuit-desc = A light hardsuit for low-intensity repairs around the station
