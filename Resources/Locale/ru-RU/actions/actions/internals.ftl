...
action-description-internals-toggle-on = Дышите из экипированного дыхательного аппарата и газового баллона.
action-name-internals-toggle-off = Отключить подачу воздуха
action-description-internals-toggle-off = Дышите атмосферой окружающей среды.
